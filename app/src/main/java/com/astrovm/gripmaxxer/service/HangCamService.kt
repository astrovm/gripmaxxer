...
import com.astrovm.gripmaxxer.datastore.WorkoutSession
...
import com.astrovm.gripmaxxer.reps.PushUpRepDetector
import com.astrovm.gripmaxxer.reps.RepCounterConfig
import com.astrovm.gripmaxxer.reps.RepEngine
import com.astrovm.gripmaxxer.reps.SquatActivityDetector
import com.astrovm.gripmaxxer.reps.SquatRepDetector
...
class HangCamService : LifecycleService() {
    ...
    companion object {
        ...
        const val ACTION_START = "com.astrovm.gripmaxxer.action.START"
        const val ACTION_STOP = "com.astrovm.gripmaxxer.action.STOP"
